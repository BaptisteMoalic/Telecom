...
function retval = BER_treshold_BCH1(nb_err_treshold,BER_treshold,SNR_bit,N_bits,N,nb_iter_max,nb_err_min,const, M_const,H_toeplitz,No)

% coding prerequisites
poly_modulo = [1, 0, 1, 0, 0, 1];
deg_poly = length(poly_modulo)-1;
[table_err, table_syndromes] = table_syndromes_1(poly_modulo, N);
